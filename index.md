    ...
    <table class="pricing-table" style="width:100%;border-collapse:collapse;box-shadow:0 2px 8px rgba(0,0,0,0.08);overflow:hidden;border-radius:8px;">
      ...
      <tbody>
        ...
        <tr style="background:#fafafa;">
          ...
          <td style="padding:12px;">Content writing, product data entry, multilingual, advanced analytics, custom plugin/API work</td>
...
<form action="https://formspree.io/f/xwpkjyby" method="POST">
